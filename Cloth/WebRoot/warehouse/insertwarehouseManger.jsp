...
<html>
  ...
  <form action="Warehouse/addwarehouseInfo.action" method="post">
  	 <table align="center" cellpadding="0" cellspacing="0" width="400" height="300">
  			<tr>
    			<td align="center">仓库名称:</td>
    			<td align="center"><input type="text" name="warehouseName"></td>
    		</tr>
    		<tr>
    			<td align="center">仓库地址:</td>
    			<td align="center"><input type="text" name="warehouseAddress"></td>
    		</tr>
    		<tr>
